...
# --- CÁLCULOS PRIMEIRO ---
# É essencial calcular as variáveis ANTES de usá-las.
...
**Poder Explicativo ($R^2$)**: O Coeficiente de Determinação foi de $R^2$ = `r round(r2, 4)`.

**Interpretação do Coeficiente ($\beta_1$)**: O coeficiente angular $\beta_1$ = `r round(b1, 2)` 
